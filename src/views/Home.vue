...
import { IdentificationIcon, TvIcon, ChatBubbleOvalLeftEllipsisIcon, CodeBracketIcon, WrenchScrewdriverIcon, CurrencyYenIcon, QrCodeIcon, AdjustmentsHorizontalIcon } from '@heroicons/vue/24/outline'
